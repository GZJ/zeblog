...
#+begin_src sh
emacs -q --eval '(progn (add-to-list (quote load-path) (car (directory-files (concat user-emacs-directory "elpa/") t "xmlgen-"))) (add-to-list (quote load-path) default-directory) (require (quote zeblog)) (zeblog-init "./test"))'
#+end_src
